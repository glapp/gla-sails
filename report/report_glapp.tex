...
On the other hand, while the learning algorithms with standard function approximation in BURLAP library does not handle discrete string-value feature in states, other function approximation method can be implemented.
