...
Classes in the package \texttt{ch.uzh.glapp.mdp} are implementation according to the BURLAP framework \todo{http://burlap.cs.brown.edu/tutorials/bpl/p4.html\#qlearn}.
\begin{itemize}
...
As discussed in section 3.3.6, MAPE allows custom learning algorithm to used in place of existing rule-based adaptations.
